...
import CadastroSetores from './views/cadastro-setores';
import ListagemSetores from './views/listagem-setores';
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path='/cadastro-setores/:idParam?' element={<CadastroSetores />} />
        <Route path='/listagem-setores' element={<ListagemSetores />} />
